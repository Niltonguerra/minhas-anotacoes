...
void funcao ()
{
    ...
    for ( i = 0 ; i <= 7; i++ )
    {
        ...
        PORTBbits.RB0 = 1; delay(10); PORTBbits.RB0 = 0; delay(10);
        PORTDbits.RD0 = bits[8] & (0000 0001<<i);
