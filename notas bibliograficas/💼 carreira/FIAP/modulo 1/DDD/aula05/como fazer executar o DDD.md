...
- essa é a camada de infraestrutura, ela facilita a comunicação entre as camadas superiores e os recursos externos, ela é essential para permitir que recursos externos como banco de dados, serviço de email e etc possam se comunicar com outras camadas da aplicação 
